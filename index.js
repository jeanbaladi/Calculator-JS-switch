$(function() {
    ...
    function showResult(res) {
        $(".operations").append(`${num1} ${operator} ${num2} = ${res} <br>`);
        deleteAll();
        result = res;
    ...
    function mayor() {
        const numbers = num1.split('');
        const res = numbers.reduce((a , b) =>  Math.max(a , b))
        num1 = res;
    }
    function menor(){
        const numbers = num1.split('');
        const res = numbers.reduce((a , b) => Math.min(a , b))
        num1 = res;
    }
    function raizCuadrada(){
        ...
        operator = "√²";
        num2 = '';
        return num1 = res , showResult(res);
    }
    function logaritmo2() {
        let res = Math.log2(num1);
        operator = "log²"
        num2 = '';
        return num1 = res , showResult(res);
    }
